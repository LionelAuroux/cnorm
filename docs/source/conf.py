...
# -*- coding: utf-8 -*-
#
# pyrser documentation build configuration file, created by
...
# MODIF
from setup import version, release
...
latex_documents = [
  ('index', 'cnorm.tex', 'Cnorm Documentation',
   'Cnorm authors', 'manual'),
]
...
man_pages = [
    ('index', 'cnorm', 'Cnorm Documentation',
     ['Cnorm authors'], 1)
]
...
texinfo_documents = [
  ('index', 'cnorm', 'cnorm Documentation',
   'Cnorm authors', 'cnorm', 'One line description of project.',
   'Miscellaneous'),
]
